...
def parse_arguments():
    ...
    parser.add_argument("--inputFasta", help="[required] input fasta sequence for various strains sequences.", default="/dev/null")
    parser.add_argument("--refGenome", help="[required] reference fasta sequence ID.", default=None)
    parser.add_argument("--wkdir", help="[optional] working directory (default='./')", default="./")
    parser.add_argument("--outputbase", help="[optional] output name base (default='output').", default="output")
